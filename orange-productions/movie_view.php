...
if (array_key_exists("project_id", $_GET)) {
    ...
    $query = "select project_id, project_name, genre, year, director, emp_name, synopsis from project natural join employee where stage_no = 5 and project_id= $project_id";
...
?>
    <div class="container fullwidth">
        ...
        <p>
            <label for="project_name">영화제목</label>
